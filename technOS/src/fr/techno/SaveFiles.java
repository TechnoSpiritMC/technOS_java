...
public class SaveFiles {
    ...
    public static void main(String[] args) {
        String filePath = "main.filemanager";
        try {
            Map<String, Map<String, String>> yamlData = loadDataFromFile(filePath);

            printData(yamlData);

            addFile("a", "folder", "none", "/path/to/file", "group1", yamlData);
    ...
    public static void addFile(String name, String type, String extension, String path, String group, Map<String, Map<String, String>> yamlData) {
        Map<String, String> fileData = new HashMap<>();
        fileData.put("type", type);
        fileData.put("extension", extension);
        fileData.put("path", path);
        fileData.put("group", group);
